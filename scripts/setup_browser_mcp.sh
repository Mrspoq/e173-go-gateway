...
echo "Setting up Browser Automation MCP for UI Testing..."

# Create MCP directory
mkdir -p /root/e173_go_gateway/mcp/browser-automation

# Create package.json
cat > /root/e173_go_gateway/mcp/browser-automation/package.json << 'EOF'
{
  "name": "e173-browser-automation-mcp",
  "version": "1.0.0",
  "description": "Browser automation MCP for E173 Gateway UI testing",
  "main": "index.js",
  "scripts": {
    "start": "node index.js"
  },
...
cat > /root/e173_go_gateway/mcp/browser-automation/index.js << 'EOF'
...
echo "Browser automation MCP setup complete!"
echo "To start the MCP server, run: node /root/e173_go_gateway/mcp/browser-automation/index.js"
echo "The server will run on port 3001"